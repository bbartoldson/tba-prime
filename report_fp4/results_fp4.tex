...
stable at 60-step smoke scale; checkpoints verified on-grid. The six FP4
arms are submitted ($\beta{=}0$ ladder at async $\{1,10,32\}$, rescue arms at
$\beta c = 0.0045$ for $\Delta{=}10$ and $32$, and the asymmetric arm); the
async-1 arm is running cleanly, with first evals $0.600$ at step 0 and
$0.615$ at step 20 (partial --- two points only).
